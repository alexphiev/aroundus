...
export default function MobileBottomNav() {
  ...
  return (
    <div className="bg-background border-border/20 fixed right-0 bottom-0 left-0 z-50 h-18 border-t md:hidden">
        ...
        {navLinks.map((link) => {
          ...
          return (
            <Link
              ...
              className="flex min-w-0 flex-1 flex-col items-center justify-center rounded-lg px-3 py-2 transition-colors"
            >
              <Icon
