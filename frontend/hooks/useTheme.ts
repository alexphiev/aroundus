import { themeClasses, statusColors, type StatusVariant } from '@/types/theme.types';
...
export function useTheme() {
   ...
   */
  const getBadgeClass = (variant: StatusVariant, additionalClasses?: string) => {
   ...
   */
  const getIconContainerClass = (small?: boolean, additionalClasses?: string) => {
    return cn(
   ...
   */
  const getSkeletonClass = (variant: keyof typeof themeClasses.skeleton, additionalClasses?: string) => {
   ...
   */
  const getLayoutClass = (variant: keyof typeof themeClasses.layout, additionalClasses?: string) => {
   ...
   */
  const getTextClass = (variant: keyof typeof themeClasses.text, additionalClasses?: string) => {
   ...
   */
  const getSpacingClass = (variant: keyof typeof themeClasses.spacing, additionalClasses?: string) => {
   ...
   */
  const getMotionClass = (variant: keyof typeof themeClasses.motion, additionalClasses?: string) => {
